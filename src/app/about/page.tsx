...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I am Diego, a Fullstack Engineer',
}
  ...
  return (
    <Container className="mt-16 sm:mt-32">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:pl-20">
          <ul role="list">
            <SocialLink href="https://github.com/ddcsoftdev" icon={GitHubIcon} className="mt-4">
              Follow on GitHub
            </SocialLink>
            <SocialLink href="https://www.linkedin.com/in/diegoddemarco/" icon={LinkedInIcon} className="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
